...
func NewHelloAPIAPI(spec *loads.Document) *HelloAPIAPI {
	return &HelloAPIAPI{
		...
		GetGoNameHandler: GetGoNameHandlerFunc(func(params GetGoNameParams) middleware.Responder {
			return middleware.NotImplemented("operation GetGoName has not yet been implemented")
		}),
...
/*HelloAPIAPI HTTP server Go with Swagger endpoints documantation */
type HelloAPIAPI struct {
	...
	// GetGoNameHandler sets the operation handler for the get go name operation
	GetGoNameHandler GetGoNameHandler
...
func (o *HelloAPIAPI) Validate() error {
	...
	if o.GetGoNameHandler == nil {
		unregistered = append(unregistered, "GetGoNameHandler")
	}
...
func (o *HelloAPIAPI) initHandlerCache() {
	...
	o.handlers["GET"]["/go/{name}"] = NewGetGoName(o.context, o.GetGoNameHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
