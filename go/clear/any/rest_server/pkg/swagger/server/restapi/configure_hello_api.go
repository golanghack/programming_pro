...
func configureAPI(api *operations.HelloAPIAPI) http.Handler {
	...
	if api.GetGoNameHandler == nil {
		api.GetGoNameHandler = operations.GetGoNameHandlerFunc(func(params operations.GetGoNameParams) middleware.Responder {
			return middleware.NotImplemented("operation operations.GetGoName has not yet been implemented")
		})
	}
