...
class SortedList:
    ...
    def __init__(self, sequence: List[int]=None, key: int=None) -> None:
        """Creates a Sorted Kisrt that orders using < on the items, 
        or on the resukts of using the given key function
    ...
    def _bisect_left(self, value: Any) -> Tuple:
    ...
    def add(self, value: Any) -> None:
        ...
        index = self._bisect_left(value)[1]
    ...
    def remove(self, value: Any) -> None:
        """Removes the first occurance of value from the list
        ...
        key, index = self._bisect_left(value)
        while (index < len(self.__list) and 
            ...
            index += 1
        raise ValueError(
            f'{self.__class__.__name__}.remove(x): x not in list'
        )

    def remove_every(self, value: Any) -> int:
    ...
    def index(self, value: Any) -> int:
        ...
        if (index < len(self.__list) and 
            ...
            return index
        raise ValueError(
            f'{self.__class__.__name__}.index(x): x not in list'
        )

    def __delitem__(self, index: int) -> List:
