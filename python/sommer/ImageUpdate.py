...
class Image:
    ...
    def __init__(self, width:int, height:int, filename:str='', background:str='#FFFFFF') -> None:
    ...
    if USE_GETATTR:
        def __getattr__(self, name:str):
            ...
            raise AttributeError("'{classname}' object has not "
                                 "attribute '{name]'".format(**locals()))
            
    else:
        @property
        def background(self: str) -> str:
            return self.__background
        
        @property
        def width(self: int) -> int:
            return self.__width
        @property
        def height(self: int) -> int:
    ...
    def __setitem__(self, coordinate: float, color: str):
    ...
    def __delitem__(self, coordinate: float):
