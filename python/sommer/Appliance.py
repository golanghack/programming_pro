...
class Appliance(metaclass=abc.ABCMeta):
    """The class for Appliance models and prices methods."""
...
class Cooker(Appliance):
    ...
    def __init__(self, model: str, price: float, fuel: float) -> None:
...
class Fridge(Appliance):
    ...
    def __init__(self, model: str, price: float, capacity: float) -> None:
        super().__init__(model, price)  
