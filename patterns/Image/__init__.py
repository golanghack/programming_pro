...
for name in os.listdir(os.path.dirname(__file__)):
    if not name.startswith("_") and name.endswith(".py"):
        ...
        try:
            ...
            warnings.warn(f"failed to load Image module: {err}")
del name, module


class Image:

    def __init__(self, width: int=None, height: int=None, filename: str=None,
            background: str=None, pixels: int=None) -> None:
    ...
    @classmethod
    def from_file(Class, filename: str):
        return Class(filename=filename)


    @classmethod
    def create(Class, width: int, height: int, background: str=None):
        return Class(width=width, height=height, background=background)


    @classmethod
    def from_data(Class, width: int, pixels: int):
    ...
    def load(self, filename: str) -> None:
        ...
        if module is not None:
            ...
            raise Error(f"no Image module can load files of type {os.path.splitext(filename)[1]}")
    ...
    def save(self, filename: str=None) -> None:
        ...
        if module is not None:
            ...
            raise Error(f"no Image module can save files of type {os.path.splitext(filename)[1]}")


    @staticmethod
    def _choose_module(actionName: str, filename: str) -> str:
        bestRating = 0
        bestModule = None
    ...
    def line(self, x0: int, y0: int, x1: int, y1: int, color: str):
    ...
    def rectangle(self, x0: int, y0: int, x1: int, y1: int, outline: str=None, fill: str=None):
    ...
    def ellipse(self, x0: int, y0: int, x1: int, y1: int, outline: str=None, fill: str=None):
