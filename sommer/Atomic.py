...
class Atomic:
    ...
    def __init__(self, container,  deep_copy: bool=False) -> None:
        assert isinstance(container, 
                          (collections.MutableSequence, 
                            collections.MutableSet, 
                                collections.MutableMapping)), ('Atomic requires a mutable collection')
        if __debug__ and isinstance(container, (collections.MutableSet, collections.MutableMapping)):
            assert (hasattr(container, 'clear') and hasattr(container,'update')), ('Atomic ', 
    ...
    def __exit__(self, exc_type, exc_val, exc_tb) -> None:
        if exc_type is None:
            ...
            if isinstance(self.original, (collections.MutableSet, collections.MutableMapping)):
                self.original.clear()
