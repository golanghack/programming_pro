...
class GenericDescriptor:
    ...
    def __init__(self, getter: str, setter: str) -> None:
        self.getter = getter
        self.setter = setter
    ...
    def __set__(self, instance: str, value: str):
        return self.setter(instance, value)
    
def valid_string(attr_name: str, empty_allowed: bool=True, regex: str=None, acceptable: str=None):
    def decorator(cls):
        name = '__' + attr_name
        def getter(self):
