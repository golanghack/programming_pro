...
def is_balanced(text, brackets='(){}[]<>'):
    """Returns True if all the brackets in tne text are balanced
    
    For each pair of brackets, the left and right braket characters
    must different.
...
def shorten(text, lenght=25, indicator='...'):
    """Returns text or truncated copy with the indicator added 
